...
export function getMockStore<
	const StoreSchemas extends UnknownStoreSchemas,
	StoreName extends StringKey<StoreSchemas>,
>(_storeSchemas: StoreSchemas, storeName: StoreName) {
...
export function getStore<
	const StoreSchemas extends UnknownStoreSchemas,
	StoreName extends StringKey<StoreSchemas>,
>(connection: Promise<IDBDatabase>, storeSchemas: StoreSchemas, storeName: StoreName) {
